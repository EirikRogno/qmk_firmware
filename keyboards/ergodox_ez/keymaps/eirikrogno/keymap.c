...
[BASE] = LAYOUT_ergodox_pretty(
  ...
  LT(SYMB, KC_NO),KC_Z,       KC_X,          KC_C,    KC_V,    KC_B,    HYPR_T(KC_NO),                 MEH_T(KC_NO), KC_N,    KC_M,    KC_COMM, KC_DOT,   KC_SLSH,        LT(SYMB, KC_NO),
  KC_GRV,          KC_QUOT,     LALT(KC_LSFT), KC_LEFT, KC_RGHT,                                              KC_UP,   KC_DOWN, KC_LBRC, KC_RBRC, TT(SYMB),
                                                        LT(MDIA, KC_NO), KC_LGUI,                 KC_LALT, LT(MDIA, KC_NO),
                                                                          KC_HOME,                 KC_PGUP,
...
[SYMB] = LAYOUT_ergodox_pretty(
  ...
  KC_TRNS, KC_EXLM, KC_AT,   KC_LCBR, KC_RCBR, KC_PIPE, KC_TRNS,     KC_TRNS, KC_UP,   KC_7,    KC_8,    KC_9,    NO_AA, KC_F12,
  KC_TRNS, KC_HASH, KC_DLR,  KC_LPRN, KC_RPRN, KC_GRV,                        KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT,NO_OSTR, NO_AE,
